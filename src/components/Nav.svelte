...
<div class="navbar bg-base-100 shadow-xl rounded-box sm:max-w-xs lg:hidden">
		...
		<div class="dropdown">
			...
			>
				...
				<li>
					<a
						target="_blank"
						href="https://drive.google.com/file/d/1nKulElQ6dmT1oYSMiIR6gysoQrysPAJy/view?usp=sharing"
						>CV Actualizado</a
					>
				</li>
			</ul>
	...
	<div class="navbar-center">
		<a class="btn btn-ghost normal-case text-xl" href="/">Santiago García</a>
	</div>
...
<div class="navbar bg-base-200 hidden lg:flex ">
	<div class="flex-1">
		<a class="btn btn-ghost normal-case text-xl" href="/">Santiago García</a>
	</div>
	<div class="flex-none">
